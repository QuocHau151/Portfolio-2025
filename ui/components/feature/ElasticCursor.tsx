    ...
    <>
      <div
        ...
        className={cn(
          ...
          "jelly-blob pointer-events-none fixed top-0 left-0 z-[999] rounded-lg will-change-transform",
      ...
      ></div>
      <div
        className="pointer-events-none fixed h-3 w-3 translate-x-[-50%] translate-y-[-50%] rounded-full transition-none duration-300"
        style={{
          top: y,
          left: x,
          backdropFilter: "invert(100%)",
