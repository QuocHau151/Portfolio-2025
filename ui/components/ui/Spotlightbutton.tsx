...
export function SpotlightButton({
  ...
  return (
    <div style={{ transform: "none" }} className={className}>
      <button className="group relative inline-block cursor-pointer rounded-xl bg-zinc-900 p-px leading-6 font-semibold text-white no-underline shadow-2xl shadow-zinc-900">
