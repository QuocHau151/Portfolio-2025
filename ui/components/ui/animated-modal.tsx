    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          className="modall fixed inset-0 z-50 flex h-full w-full items-center justify-center [perspective:800px] [transform-style:preserve-3d]"
        >
          <Overlay />
...
export const ModalContent = ({
  ...
  return (
    <div className={cn("flex flex-1 flex-col p-3 md:p-10", className)}>
      {children}
    </div>
  );
};
...
const Overlay = ({ className }: { className?: string }) => {
  ...
  return (
    <motion.div
      ...
      className={`modal-overlay bg-opacity-50 fixed inset-0 z-50 h-full w-full bg-black ${className}`}
