...
export function LampDemo() {
  return (
    <LampContainer>
      ...
      >
        <h1 className="py-4 text-center text-4xl font-bold tracking-tight text-transparent text-white md:text-5xl">
          Lý Do Chọn
          <br />
          Khang Minh Lighting ?
        </h1>
        <p className="pb-10 text-center text-sm text-slate-300 md:px-60 lg:px-80">
          Cam kết của chúng tôi về chất lượng, sự tiện lợi và sự hài lòng của
          khách hàng thúc đẩy mọi khía cạnh trong dịch vụ của chúng tôi, đảm bảo
          quản áo của bạn nhận được sự chăm sóc xứng đáng.
        </p>
        <div className="grid grid-cols-1 gap-2 pb-10 md:grid-cols-2 lg:grid-cols-4">
          <div className="rounded-lg bg-white p-6 shadow-sm transition-shadow hover:shadow-md">
            <div className="mb-6 h-16 w-16 rounded-lg">
              <svg
            ...
            <p className="text-sm text-gray-600">
              Chúng tôi cam kết cung cấp các sản phẩm chính hãng, đạt tiêu chuẩn
              quốc tế về chất lượng và an toàn.
            </p>
          </div>
              ...
              >
                ...
                <g id="SVGRepo_iconCarrier">
                  ...
                  <g id="Renewable_energy">
                    {" "}
                    <path d="M305.19,153.77a10.46,10.46,0,0,0-9.78-14.19h-68a10.48,10.48,0,0,0-10.24,8.29L187.8,286.15A10.46,10.46,0,0,0,198,298.79H242.4a10.47,10.47,0,0,1,10.28,12.45l-11,57c-2,10.41,12.09,15.64,17.36,6.45L329,252.79a10.47,10.47,0,0,0-9.08-15.68H288.7a10.47,10.47,0,0,1-9.79-14.19Z"></path>{" "}
            ...
            <div className="mb-6 h-16 w-16 rounded-lg">
              ...
              >
                <g id="SVGRepo_iconCarrier">
                  ...
                  <g id="Shopicon">
                    {" "}
                    <circle cx="20.083" cy="17.997" r="2"></circle>{" "}
                    <circle cx="28.002" cy="17.997" r="2"></circle>{" "}
                    <path d="M24.083,31.913C28.448,31.913,32,28.363,32,24h-4c0,2.157-1.757,3.913-3.917,3.913S20.166,26.157,20.166,24h-4 C16.166,28.363,19.718,31.913,24.083,31.913z"></path>{" "}
                    <path d="M41.369,19.029C39.205,11.517,32.282,6,24.083,6S8.961,11.517,6.797,19.029C5.282,19.177,4.083,20.448,4.083,22v4 c0,1.65,1.35,3,3,3c1.65,0,3-1.35,3-3v-2.002C10.084,16.279,16.364,10,24.083,10c7.72,0,14,6.28,14,14s-6.28,14-14,14v0h-2.014 c-1.65,0-3,1.35-3,3s1.35,3,3,3h4.014c1.552,0,2.824-1.199,2.971-2.714c5.931-1.709,10.606-6.384,12.315-12.315 c1.515-0.147,2.714-1.419,2.714-2.971v-4C44.083,20.448,42.884,19.176,41.369,19.029z"></path>{" "}
                  </g>{" "}
                </g>
              </svg>
            </div>
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative z-0 mb-10 flex h-full w-full flex-col items-center justify-center overflow-hidden bg-slate-950 pt-80 pb-20",
        className,
      )}
    >
      <div className="relative isolate z-0 flex w-full flex-1 scale-y-125 items-center justify-center">
        ...
        <motion.div
          ...
          className="absolute inset-auto z-50 h-0.5 w-[20rem] -translate-y-[7rem] bg-orange-300"
        ></motion.div>
